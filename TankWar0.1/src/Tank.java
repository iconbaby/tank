...
public class Tank {
	...
	public void draw(Graphics g) {
		...
		case D:
			g.drawLine(x + Tank.WIDTH/2,y +  HEIGHT/2, x + Tank.WIDTH/2, y + Tank.HEIGHT);
			break;

		case L:
			g.drawLine(x + Tank.WIDTH/2,y +  HEIGHT/2, x, y + Tank.HEIGHT/2);
			break;

		case R:
			g.drawLine(x + Tank.WIDTH/2,y +  HEIGHT/2, x + Tank.WIDTH, y + Tank.HEIGHT/2);
			break;

		case LU:
			g.drawLine(x + Tank.WIDTH/2,y +  HEIGHT/2, x, y);;
			break;

		case RU:
			g.drawLine(x + Tank.WIDTH/2,y +  HEIGHT/2, x + Tank.WIDTH, y);
			break;

		case LD:
			g.drawLine(x + Tank.WIDTH/2,y +  HEIGHT/2, x, y + Tank.HEIGHT);
			break;

		case RD:
			g.drawLine(x + Tank.WIDTH/2,y +  HEIGHT/2, x + Tank.WIDTH, y + Tank.HEIGHT);
			break;
